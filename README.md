...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/OGrdcYY2XG)
...
```sh
npx nx serve travel-planner
```

To create a production bundle:

```sh
npx nx build travel-planner
```

To see all available targets to run for a project, run:

```sh
npx nx show project travel-planner
```
